...
public abstract class Unidad {
	...
	// public Unidad(int sa, int at, int de, int en, double mi, double ma, Punto
	// posicion2) {
	// this.salud = sa;
	// this.ataque = at;
	// this.defensa = de;
	...
	public boolean puedeAtacar(Unidad unidad) {
		...
		if (distancia >= this.distanciaMinima && (this.distanciaMaxima > 0 ? distancia <= this.distanciaMaxima : true)
